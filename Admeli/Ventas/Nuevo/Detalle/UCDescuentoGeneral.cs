...
{
    public partial class UCDescuentoGeneral : UserControl
    {
        ...
        public UCDescuentoGeneral()
        {
            InitializeComponent();
        }

        public UCDescuentoGeneral(FormClienteNuevo formClienteNuevo)
        {
            InitializeComponent();
        ...
        private void UCDescuentoGeneral_Paint(object sender, PaintEventArgs e)
        {
