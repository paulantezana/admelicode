...
{
    public partial class UCGeneralesCD : UserControl
    {
        ...
        private FormCompraNuevo1 formProductoNuevo;

        public UCGeneralesCD()
        {
            InitializeComponent();
        }

        public UCGeneralesCD(FormCompraNuevo1 formProductoNuevo)
        {
            InitializeComponent();
