...
{
    public partial class UCImpuestoPDN : UserControl
    {
        ...
        public UCImpuestoPDN()
        {
            InitializeComponent();
        }

        public UCImpuestoPDN(FormProductoNuevo formProductoNuevo)
        {
            InitializeComponent();
        ...
        internal async void reLoad()
        {
            ...
            //Esperando el idSucursal
            int esp = await cargarSucursal();
